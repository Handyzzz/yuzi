...
@interface WYCommonFriendsListVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation WYCommonFriendsListVC
...
-(void)initData{
    ...
    __weak WYCommonFriendsListVC *weakSelf = self;
    //第一次 不需要下拉的效果
    [self.tableView showHUDNoHide];
    [WYUserDetailApi listCommonFriends:self.userUuid Page:self.page Block:^(NSArray *moreFrdendsArr, BOOL hasMore) {
