...
@implementation WYPublishTagListCell
...
-(UIImageView *)removeIV{
    if (_removeIV == nil) {
        _removeIV = [UIImageView new];
        [self.contentView addSubview:_removeIV];
        [_removeIV mas_makeConstraints:^(MASConstraintMaker *make) {
